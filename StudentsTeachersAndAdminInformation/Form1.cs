...
{
    public partial class InfoSystem : Form
    {
        public InfoSystem()
        {
            InitializeComponent();
        ...
        private void SaveStudentInfoWhenClicked(object sender, EventArgs e)
        {
        ...
        private void ClearOutStudentInfoWhenClicked(object sender, EventArgs e)
        {
